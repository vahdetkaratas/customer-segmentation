...
def scale_rfm_data(rfm_data):
    ...
    print("\nScaling Statistics:")
    print(
        f"  Recency - Mean: {rfm_scaled['Recency_Scaled'].mean():.6f}, Std: {rfm_scaled['Recency_Scaled'].std():.6f}"
    )
    print(
        f"  Frequency - Mean: {rfm_scaled['Frequency_Scaled'].mean():.6f}, Std: {rfm_scaled['Frequency_Scaled'].std():.6f}"
    )
    print(
        f"  Monetary - Mean: {rfm_scaled['Monetary_Scaled'].mean():.6f}, Std: {rfm_scaled['Monetary_Scaled'].std():.6f}"
    )
