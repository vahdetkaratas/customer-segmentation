...
def test_rfm_scaling_data_quality(project_root):
    ...
    for col, expected_dtype in expected_dtypes.items():
        assert (
            str(rfm_scaled[col].dtype) == expected_dtype
